INSERT INTO `crm-berezino`.`Employee_Roles`(name)
VALUES
    ('duty_admin'),
    ('senior_admin'),
    ('manager');

INSERT INTO `crm-berezino`.`Login_Credentials`(username, password_hash, password_salt, user_type)
VALUES
...
INSERT INTO `crm-berezino`.`Employees`(first_name, last_name, middle_name, credentials_id, role_id)
VALUES
    ('Petr', 'Petrov', 'Petrovich', 1, 1);

INSERT INTO `crm-berezino`.`Customers`(name, credentials_id)
VALUES
    ('Kerech', 'Nechaev', 'Kerechevech', 2);
